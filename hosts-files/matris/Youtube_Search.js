registerPlugin({
    name: 'Youtube Arama | RouterScript',
    version: '1.0.0',
    engine: '>= 0.9.21',
    backends: ["ts3", "discord"],
    description: 'RouterScript özel, sorunsuz versiyonu.',
    author: 'RouterScript (powered by NT5)',
    vars: [
        {
            name: 'yt_apikey',
        ...
        },
        {
            ...
            title: 'Mesaj formatı',
            type: 'multiline',
            placeholder: '[B][color=purple]RouterScript[/color] | [color=blue]Youtube Arama[/color] [color=green]~[/color] {title} oynatılıyor...[/B]'
        },
        {
    ...
    var youtube = {
        config: {
            ...
            plugin: {
                ...
                command_message: config.command_message || '[B][color=purple]RouterScript[/color] | [color=blue]Youtube Arama[/color] [color=green]~[/color] {title} oynatılıyor...[/B]',
